...
if __name__ == "__main__":
	...
	margin = 0.5
	left_output = model(left, is_training=True, reuse=False)
	right_output = model(right, is_training=True, reuse=True)
	...
	with tf.Session() as sess:
		...
		saver.save(sess, "siamesenetwork-tensorflow-master/model/model.ckpt")
