...
if __name__ == "__main__":
    ...
    with tf.Session() as sess:
        ...
        constant_graph = graph_util.convert_variables_to_constants(sess, sess.graph_def, ['model/dense1/biases'])
        ...
        # model_ops = tf.get_default_graph()
        # slim.model_analyzer.analyze_ops(model_ops, print_info=True)
